...
public class DocumentProcessor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String document = "SUVA_Checkliste_Rueckbau.d.pdf";
        String bucket = "textract-console-us-east-2-d498a35d-5129-4e88-9ace-81218d3dece4";
        String roleArn="arn:aws:iam::384160496997:role/TextractServiceRole";

        
        EndpointConfiguration snsendpoint = new EndpointConfiguration(
                "https://sns.us-east-2.amazonaws.com", "us-east-2");
        
        sns= AmazonSNSClientBuilder.standard()
                .withEndpointConfiguration(snsendpoint)
                .withCredentials(new ProfileCredentialsProvider("profile2"))
                .build();
        
        EndpointConfiguration sqsendpoint = new EndpointConfiguration(

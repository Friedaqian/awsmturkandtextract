...
public class GetAccountBalanceSample {
	...
	public static void main(final String[] argv) throws IOException {
		final GetAccountBalanceSample credentialprovider = new GetAccountBalanceSample(DefaultAWSCredentialsProviderChain());
		System.out.println("Credentialprovider " + credentialprovider);
		/* 
	...
	private static AmazonMTurk DefaultAWSCredentialsProviderChain() {
		Regions region = Regions.US_EAST_1;
		AmazonMTurkClientBuilder builder = AmazonMTurkClientBuilder.standard();
		builder.withRegion(region).withCredentials(new EnvironmentVariableCredentialsProvider());

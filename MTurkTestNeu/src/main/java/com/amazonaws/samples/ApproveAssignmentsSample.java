...
public class ApproveAssignmentsSample {
	...
	private static final String HIT_ID_TO_APPROVE = "39KV3A5D2EUE8VGOEJFVDVOI3GPS77";
	...
	*/
	...
	private void approveAssignment(final String hitId) {
		...
		for (Assignment asn : assignmentList) {
			...
			// Approve the assignment, what is true
			if(!asn.getAnswer().isEmpty()){
			...
			rejectRequest.setRequesterFeedback("the answer must be reject, thank you for your hard work.");
